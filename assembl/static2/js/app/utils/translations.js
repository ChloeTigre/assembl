...
const Translations = {
  fr: {
    ...
    login: {
      ...
      lowerCasePassword: "Une minuscule",
      lengthPassword: "9 caractères",
    ...
    debate: {
      ...
      confirmRefusalBody: "Êtes-vous sûr de vouloir refuser ce message ?",
      ...
      syntheses: {
        ...
        save: "Enregistrer",
        saveAndBackDraft: "Enregistrer et repasser en brouillon",
        saveAndPost: "Enregistrer et publier",
      ...
      thread: {
        ...
        translate: "Traduire",
        removeTranslation: "Enlever traduction",
    ...
    administration: {
      ...
      deleteGauge: "Supprimer la jauge",
